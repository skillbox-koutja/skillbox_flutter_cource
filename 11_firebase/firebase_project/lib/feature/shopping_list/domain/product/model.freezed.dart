...
abstract class $ProductCopyWith<$Res> {
  ...
  @useResult
  $Res call({UuidValue id, String title, double price, ProductStatus status});
}
...
class _$_Product extends _Product {
  const _$_Product({required this.id, required this.title, required this.price, required this.status}) : super._();
  ...
  @override
  String toString() {
    return 'Product(id: $id, title: $title, price: $price, status: $status)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, title, price, status);
